...
namespace PlayGround.Engine.Emitters 
{
    abstract public class Emitter : Control
    {
        ...
        /// </summary>
        static readonly DependencyProperty MaxPositionOffsetXProperty = DependencyProperty.Register(
            "MaxPositionOffsetX", typeof(double), typeof(Emitter), new PropertyMetadata(0.01d));
        public double MaxPositionOffsetX
        {
            get { return (double)GetValue(MaxPositionOffsetXProperty); }
            set { SetValue(MaxPositionOffsetXProperty, value); }
        }
        static readonly DependencyProperty MaxPositionOffsetYProperty = DependencyProperty.Register(
            "MaxPositionOffsetY", typeof(double), typeof(Emitter), new PropertyMetadata(0.01d));
        public double MaxPositionOffsetY
        {
            get { return (double)GetValue(MaxPositionOffsetYProperty); }
            set { SetValue(MaxPositionOffsetYProperty, value); }
        }

		/// <summary>
		/// Dependency Property which maintains the minimum offset for the position of a particle.
		/// </summary>
		static readonly DependencyProperty MinPositionOffsetXProperty = DependencyProperty.Register(
			"MinPositionOffsetX", typeof(double), typeof(Emitter), new PropertyMetadata(-0.01d));
		public double MinPositionOffsetX
        {
            get { return (double)GetValue(MinPositionOffsetXProperty); }
            set { SetValue(MinPositionOffsetXProperty, value); }
        }

		static readonly DependencyProperty MinPositionOffsetYProperty = DependencyProperty.Register(
			"MinPositionOffsetY", typeof(double), typeof(Emitter), new PropertyMetadata(-0.01d));
		public double MinPositionOffsetY
        {
            get { return (double)GetValue(MinPositionOffsetYProperty); }
            set { SetValue(MinPositionOffsetYProperty, value); }
        }
